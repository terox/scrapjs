var request    = require('request')
    ...
    , fs       = require('fs')
    , path     = require('path')
    , toptions = require('./tools/options')
    , tlogger  = require('./tools/logger')
    , _filters = {}
    , _modules = {}

var optionsPattern = {
    // 3600 | '3600s' | '60m' | '1h'  (default: 0)
    frequency: '^[0-9]+(s|m|h)?$'
};
...
//      }
    ...
    // Setup default options and merge with customized
    options = toptions(optionsPattern).merge(optionsByDefault, options);
